...
extern u8 random_read_one_byte(u32 address);
...
int axp209_init(void)
{
	...
	// set i2c address as 0x34 and init i2c bus
	i2c_master_devaddr(0x34);
	i2c_master_init();
